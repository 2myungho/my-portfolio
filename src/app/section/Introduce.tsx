  ...
  return (
    <section className={styles.section}>
      ...
      <div className="bg-[#f6f6f6] rounded-md p-4 md:p-8 lg:py-12 lg:px-16 ">
        ...
        <br />
        <div>
          요즘 제 취미인 운동을 주제로 한 '헛둘' 이라는 모바일 어플리케이션을
          React Native로 개발하고 사용자 피드백을 받아 지속해서 관리하고
          있습니다. 사용자들과 소통하는 것에 굉장한 보람을 느끼며, 어떻게 하면
          사용자들이 즐겁게 사용할 수 있을지, 사용에 불편한 점은 없는지 등에
          대한 문제 해결을 지속적으로 고민하고 있습니다. 이러한 인사이트를 앱의
          기획과 개발 과정에 반영하고 사용자 경험에 더욱 신경 쓰며 개발하고
          있습니다.
        </div>
        <br />
        <div>
